...
class PlanServiceTest {
    ...
    void setUp() {
        ...
        planResponseDto = projectionFactory.createProjection(PlanResponseDto.class, PlanEntityMother.getPlan());
    }
    ...
    void create() {
        ...
        given(itemRepository.findAllByCodeIn(anyList())).willReturn(List.of(ItemEntityMother.getItem()));
        given(itemsPlanRepository.save(any(ItemPlanEntity.class))).willReturn(ItemPlanEntityMother.getItemPlanEntity());
