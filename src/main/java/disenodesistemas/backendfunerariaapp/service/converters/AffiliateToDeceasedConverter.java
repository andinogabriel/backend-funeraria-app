...
public class AffiliateToDeceasedConverter implements AbstractConverter<DeceasedEntity, AffiliateRequestDto> {
    ...
    public DeceasedEntity fromDto(final AffiliateRequestDto affiliateRequestDto) {
        return DeceasedEntity.builder()
                ...
                .deceasedRelationship(mapper.map(affiliateRequestDto.getRelationship(), RelationshipEntity.class))
