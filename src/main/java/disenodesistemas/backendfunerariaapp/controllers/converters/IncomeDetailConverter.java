...
public class IncomeDetailConverter extends AbstractConverter<IncomeDetailEntity, IncomeDetailRequestDto>{
    ...
    private List<ItemEntity> findItemsByCode(final List<IncomeDetailRequestDto> incomeDetailsRequestDto) {
        final List<String> codes = incomeDetailsRequestDto.stream()
