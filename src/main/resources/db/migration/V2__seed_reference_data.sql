...
select setval('genders_seq', coalesce((select max(id) from genders), 1));
select setval('roles_seq', coalesce((select max(id) from roles), 1));
select setval('relationships_seq', coalesce((select max(id) from relationships), 1));
select setval('receipt_types_seq', coalesce((select max(id) from receipt_types), 1));
select setval('death_causes_seq', coalesce((select max(id) from death_causes), 1));
select setval('provinces_seq', coalesce((select max(id) from provinces), 1));
select setval('cities_seq', coalesce((select max(id) from cities), 1));
